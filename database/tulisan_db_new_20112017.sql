...
--
-- Host: localhost
-- Waktu pembuatan: 20 Nov 2017 pada 16.10
-- Versi server: 5.5.42
-- Versi PHP: 5.6.10
...
INSERT INTO `products` (`idData`, `name`, `sku`, `description`, `material`, `dimension`, `price`, `storyId`, `frontPicture`, `backPicture`, `topPicture`, `rightPicture`, `bottomPicture`, `leftPicture`, `createdBy`, `createdDate`, `changedBy`, `changedDate`) VALUES
(21, 'Altier Box', 'ALTBX', 'Much like the Gallery Tote, the Atelier Box has a structure that lends to organization. This attach̩ is perfect for an afternoon stroll about town or to keep at home to tidy files and accessories. The Atelier features a short handle to clutch or sling over one elbow as a sophisticated shopper. An interior split stitched pocket helps secure smaller items like a cellphone or business cards.', 'Water-resistant, non-toxic coated cotton canvas and coated polyester lining. Comes with dust bag.', '13 x 7.5 x 12 in', '7,700,000', 3, 'products_21.jpg', '', '', '', '', '', 'SESSION_TEST', '2017-10-23 20:31:01', NULL, NULL),
(22, 'Pink Bag', '123321', '', '', '', '1,000,000', 3, 'products_22.jpg', '', '', '', '', '', 'SESSION_TEST', '2017-11-16 16:35:42', NULL, NULL),
(23, 'Red Bag', '431231', '', '', '', '2,000,000', 3, 'products_23.jpg', '', '', '', '', '', 'SESSION_TEST', '2017-11-16 16:36:25', NULL, NULL);
